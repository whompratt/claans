...
if check_password():
    ...
    with st.container():
        ...
        st.write("Welcome to the Earth Strider Claan area! Here you can find all of the dice you have accumulated for the current fortnight, your magic items, and submit any quests that you have been working on!")
        st.write("---")
    ...
    with st.container():
        ...
        name = st.selectbox('Please tell me who you are!',
                            tuple(["Please select your name"] + settings['Earth Striders'])
                        )
        ...
        if st.button('Submit'):
            ...
            try:
                ...
                elif quest == "Access your Claan's secret phrase using NordLayer" and answer != st.secrets["earth_phrase"]:
